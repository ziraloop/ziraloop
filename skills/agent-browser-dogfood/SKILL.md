...
- [references/issue-taxonomy.md](references/issue-taxonomy.md) -- Severity levels, issue categories, exploration checklist. Read at the start of a session to calibrate what to look for.
